    ...
    <div className={style["container-principal"]}>
      <div className={style.leftContent}>
        <p style={{ fontSize: "14px", textAlign: "left", position: "static" }}>
          ...
          Desarrollador <strong>Full Stack Web Developer</strong> con background en estudios de arquitectura y empresas de construcción,
          valoro enormemente el trabajo en equipo. Mi pasión radica en transformar ideas en experiencias cautivadoras.  Mi enfoque profesional se
          ...
          <br /> Mis habilidades blandas incluyen la comunicación efectiva, la
          ...
          ¡Bienvenido a mi rincón digital! ¿Listo para construir algo extraordinario?
          ...
          <div className={style["tech-container"]}>
            ...
            <div className={style.TypeScript}>
              <img
                className={style["img-TypeScript"]}
                src="https://media.printables.com/media/prints/744766/images/5814515_854c67bc-6861-4faf-a006-2ea2e865b8ec_d4eec15e-d179-4f60-9b8d-25a82897e60f/thumbs/cover/800x800/png/ts-logo-512.webp"
...
//             Transformando Ideas en Experiencias Únicas
//           </h1>
//           Desarrollador con background en estudios de arquitectura y empresas de construcción,
//           valoro enormemente el trabajo en equipo. Mi pasión radica en transformar ideas en experiencias cautivadoras. 
